...
function createRoZChat() {
    ...
    function updateBoxSize() {
        if (window.innerWidth <= 768) { // 768px is a common breakpoint for mobile devices
            ...
            box.style.height = '100vh'; // Set a fixed height for desktop
            box.style.top = 'auto';
            box.style.bottom = '0';
            box.style.right = '0';
        }
